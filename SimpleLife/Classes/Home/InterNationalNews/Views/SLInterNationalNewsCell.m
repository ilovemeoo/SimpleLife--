...
@interface SLInterNationalNewsCell ()
...
@implementation SLInterNationalNewsCell

#pragma mark - 类方法创建cell
+ (instancetype)cellWithTableView:(UITableView *)tableView{
    
    static NSString *ID = @"InterNationalNews";
...
- (void)setInterNationalNewsF:(SLInterNationalNewsFrame *)interNationalNewsF
{
    _interNationalNewsF = interNationalNewsF;
    
    //title
    self.lblTitle.frame = interNationalNewsF.titleFrame;
    self.lblTitle.text = interNationalNewsF.hotNews.title;
    
    //source
    self.lblSource.frame = interNationalNewsF.sourceFrame;
    self.lblSource.text = interNationalNewsF.hotNews.source;
    
    //pubDate
    self.lblPubDate.frame = interNationalNewsF.pubDateFrame;
    self.lblPubDate.text = interNationalNewsF.hotNews.pubDate;
    
    self.imageV.frame = interNationalNewsF.imageFrame;
    self.imageV.image_urls = interNationalNewsF.hotNews.imageurls;
    
    self.seperator.frame = interNationalNewsF.viewFrame;
}
