...
#import "SLFinantialNewsParams.h"
...
@implementation SLFinantialNewsUser

+(void)getFinantialNewsWithPage:(int)page success:(void (^)(NSArray *))success failure:(void (^)(NSError *))failure
{
    SLFinantialNewsParams *params = [[SLFinantialNewsParams alloc] init];
    params.page = [NSNumber numberWithInt:page];
    
    params.channelId = @"5572a108b3cdc86cf39001d0";
