...
- (void)setHotNewsF:(SLHotNewsFrame *)hotNewsF
{
    _hotNewsF = hotNewsF;
    
    //title
    self.lblTitle.frame = hotNewsF.titleFrame;
    self.lblTitle.text = hotNewsF.hotNews.title;
    
    //source
    self.lblSource.frame = hotNewsF.sourceFrame;
    self.lblSource.text = hotNewsF.hotNews.source;
    
    //pubDate
    self.lblPubDate.frame = hotNewsF.pubDateFrame;
    self.lblPubDate.text = hotNewsF.hotNews.pubDate;
    
    self.imageV.frame = hotNewsF.imageFrame;
    self.imageV.image_urls = hotNewsF.hotNews.imageurls;
    
    self.seperator.frame = hotNewsF.viewFrame;
}
