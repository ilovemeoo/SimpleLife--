...
-(void)setWeixinF:(SLWeixinFrame *)weixinF
{
    ...
    //传递数据
    self.lblSource.frame = weixinF.sourceFrame;
    self.lblSource.text = weixinF.weixin.source;
    
    self.lblTitle.frame = weixinF.titleFrame;
    self.lblTitle.text = weixinF.weixin.title;
    
    self.imageV.frame = weixinF.firstImgFrame;
    [self.imageV sd_setImageWithURL:weixinF.weixin.firstImg placeholderImage:[UIImage imageNamed:@"timeline_image_placeholder"]];
