...
- (void)setUpViewFrame
{
    ...
    CGSize sourceSize = [_weixin.hottime sizeWithAttributes:attrSource];
    _hottimeFrame = (CGRect){{sourceX,sourceY},sourceSize};
    
    //title的frame
    CGFloat titleX = sourceX;
    CGFloat titleY = CGRectGetMaxY(_hottimeFrame) + SLCellEginset * 0.8;
